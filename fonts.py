...
game_timer_font = pygame.font.Font('data/font/rus.ttf', 24)
premove_font = pygame.font.Font('data/font/rus.ttf', 42)
win_font = pygame.font.Font('data/font/rus.ttf', 52)
results_font = pygame.font.Font('data/font/rus.ttf', 42)
